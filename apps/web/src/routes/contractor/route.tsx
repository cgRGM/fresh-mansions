...
const sidebarLinks = [
  ...
  { href: "/contractor/routes", icon: Map, label: "Routes" },
  { href: "/contractor/work-orders", icon: Briefcase, label: "Work Orders" },
  { href: "/contractor/profile", icon: User, label: "Profile" },
] as const;

const mobileLinks = [
  { href: "/contractor/dashboard", icon: LayoutDashboard, label: "Home" },
  { href: "/contractor/routes", icon: Map, label: "Routes" },
  { href: "/contractor/work-orders", icon: Briefcase, label: "Jobs" },
  { href: "/contractor/profile", icon: User, label: "Profile" },
] as const;
          ...
          <div className="animate-fade-in fixed inset-y-0 left-0 z-50 w-72 bg-gradient-to-b from-[#0a1a10] to-[#0f0f0f] text-white shadow-2xl">
            <div className="flex h-full flex-col">
              ...
              <div className="border-t border-white/8 p-4">
                <div className="[&_button]:border-white/20 [&_button]:bg-white/10 [&_button]:text-white/80 [&_button]:hover:bg-white/20 [&_button]:hover:text-white">
